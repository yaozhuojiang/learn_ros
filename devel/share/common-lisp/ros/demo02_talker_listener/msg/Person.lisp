...
(cl:in-package demo02_talker_listener-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name demo02_talker_listener-msg:<Person> is deprecated: use demo02_talker_listener-msg:Person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo02_talker_listener-msg:name-val is deprecated.  Use demo02_talker_listener-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo02_talker_listener-msg:age-val is deprecated.  Use demo02_talker_listener-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo02_talker_listener-msg:height-val is deprecated.  Use demo02_talker_listener-msg:height instead.")
  (height m))
